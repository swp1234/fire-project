...
- Optimized harness `2026-09-05T05-28-16-104Z` passed 109/109 in 1,038.2 seconds after deleting 98 syntax declarations and adding the NPC gate. Mutation, analytics 9/9, runtime 6/6 and submitted inventory 63/0 coverage remains. Markdown report size fell from 10.8 KB to 5.8 KB; future JSON reports keep full output only for failures.
- The new slowest gates are K-pop roster/guide (122.7s), English Attachment Reflection (115.2s), shared runtime smoke (62.3s) and analytics smoke (40.4s). Optimize these only after timing their internal phases; do not remove behavior or mutation coverage to improve a headline duration.

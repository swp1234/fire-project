...
- Current slow gates are English Shadow Reflection (37.1s), root focus (34.9s), K-pop roster/guide (32.3s) and NPC reset (29.6s). Profile internals before changing them; never trade behavior or mutation coverage for a shorter run.

...
- 2026-04-22: Portal HSP blog remediation completed (session378, corrected the `15-signs-highly-sensitive-person` self-canonical/og/JSON-LD URL mismatch against the separate `am-i-highly-sensitive-person-signs` article, upgraded the bottom HSP reader funnel, added inline/CTA/related `content_*` tracking, and prepared the page for live verification)

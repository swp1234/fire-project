...
const FOCUSED_INDEXING_PAGES = Object.freeze([
  ...
  ['es', 'lectura-tarot-diario-guia.html'],
...
const DEFAULT_PAGES = [
  ...
  path.join(ROOT, 'projects', 'sky-runner', 'index.html'),
  ...
  path.join(ROOT, 'projects', 'memory-card', 'index.html'),
  path.join(ROOT, 'projects', 'maze-runner', 'index.html'),
  path.join(ROOT, 'projects', 'color-memory', 'index.html'),
  path.join(ROOT, 'projects', 'road-shooter', 'index.html'),
  ...
  path.join(ROOT, 'projects', 'snake-game', 'index.html'),
  ...
  path.join(ROOT, 'projects', 'ai-personality', 'index.html'),
  path.join(ROOT, 'projects', 'emotion-temp', 'index.html'),
...
module.exports = { inspectHtml, verifyHtml };

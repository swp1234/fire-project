...
- French cognitive distortions: 15 visible teaching categories, three direct NHS/WHO sources, a private three-step check, 50%/500ms qualified exposure, four related routes, French Stress Check auto-start and selection privacy are enforced with 10 mutations at 390/1440px. Hidden FAQ, deterministic thought claims, manual ads and synthetic telemetry are forbidden.

...
- **Tier 1 High-RPM Organic Recovery & GSC Alignment (Waves 1~22)**:
  - Registered missing killer apps (`future-self` 178s, `stress-response`, `burnout-test`) in root sitemap.
  - Lifted `noindex` on 42 Tier 1 guides (Somatic Anxiety, Sensory Overload HSP, 4 Attachment Styles, Anxious Attachment, Childhood Trauma, Burnout Types, HSP Signs, 4F Trauma, Codependency, Boundaries, Cortisol, Panic EN/KO).
  - Upgraded Quick Rails to point directly to top killer tools (`stress-check`, `stress-response`, `brain-type`, `hsp-test`).
- **Verification**: Full test suite PASS (Analytics 9/9, Runtime 6/6, Indexing Inventory 117 clean, 0 errors).

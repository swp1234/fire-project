...
> 매 세션마다 자동 업데이트. **마지막:** 2026-03-23 (세션285: Shadow Work Quiz 신규 앱 + SEO 강화 + bounce 개선)
...
| 항목 | 수량 |
|------|------|
| 총 프로젝트 | **106개** (projects/ 106 디렉토리, 앱 106 + portal + _common) |
| 지원 언어 | 12개 (ko/en/zh/hi/ru/ja/es/pt/id/tr/de/fr) |
| 블로그 | **1019개** |

**앱 분류:** 유틸 12 / 바이럴 테스트 **55** / 게임 **21** / 도구 13 / 웹 2 / 운세 **4** / 신규 9
...
| 카테고리 허브 | Games(21), **Tests(37)**, Tools, MBTI (4개 랜딩페이지) |
...
| 기타 | 커스텀 404, 블로그 인덱스 12개 언어, 사이트맵 **1179 URLs**, 피드백 페이지 |
...
1. **shadow-work 12개 언어 블로그 생성** — blog-writer 에이전트 위임
2. **stress-management 블로그 pos 추적** — 내부링크 11개 앱에서 연결, 1-2주 후 확인 (현재 pos10.4)
3. **eq-test AI 프리미엄 + shadow-work 효과 모니터링** — ai_analysis_unlock 이벤트 + 신규 앱 유입
4. **toxic-trait bounce 추적** — 크로스링크 8개 + SEO 섹션 추가 효과 확인
5. **다음 신규 앱 검토** — 트렌드 기반 (Inner Child Quiz, Ego Death Test 등)

...
> 매 세션마다 자동 업데이트. **마지막:** 2026-03-14 (세션187)
...
| 항목 | 수량 |
|------|------|
| 총 프로젝트 | **99개** (projects/ 99 디렉토리, 앱 97 + portal + _common) |
| 지원 언어 | 12개 (ko/en/zh/hi/ru/ja/es/pt/id/tr/de/fr) |
| 블로그 | **615개** (ai-personality 12개 추가) |

**앱 분류:** 유틸 12 / 바이럴 테스트 **46** / 게임 **21** / 도구 13 / 웹 2 / 운세 **4** / 신규 1 (ai-personality)
...
| SEO 스키마 | FAQPage **30+앱**, BreadcrumbList **30+앱**, JSON-LD 전앱 |
...
1. **Organic 클릭 확보** — hsp-test(pos95), mbti-love(pos8), puzzle-2048(pos17) 모니터링
2. **바이럴 테스트 신규** — 트렌드 기반 2-3개 추가 (AI 관련, 심리 트렌드)
3. **블로그 퍼널 확장** — 고노출 테스트별 롱테일 키워드 블로그 추가
4. **AdSense 최적화** — Auto Ads 활성화, 인터스티셜 실험
5. **런타임 검증 확대** — 나머지 11개 게임 try-catch + Playwright 전체 실행
